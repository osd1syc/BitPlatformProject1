...
using Project1.Client.Windows.Services;
using Microsoft.Extensions.Logging;
using Microsoft.AspNetCore.Components.WebView.WindowsForms;

namespace Project1.Client.Windows;
...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "Project1.Client.Windows").Build();
