...
using Project1.Client.Maui.Services;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseSentry(options =>
            {
                var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "Project1.Client.Maui").Build();
                configuration.GetRequiredSection("Logging:Sentry").Bind(options);
            })
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "Project1.Client.Maui");
