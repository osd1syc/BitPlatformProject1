namespace Project1.Client.Core.Components.Pages;
...
/// Example Usage:
/// Opening:
///     http://localhost:5000/authorize?client_id=SampleClient&redirect_uri=https://sampleclient.azurewebsites.net/loginCallback&state=/carts
///     http://localhost:5000/authorize?client_id=NopClient&redirect_uri=https%3A%2F%2Fsampleclient.azurewebsites.net%2FLoginCallback&state=%2Fcarts
/// 
/// Redirects to:
