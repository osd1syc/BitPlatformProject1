...
using Project1.Server.Api.Controllers;
using Project1.Server.Api.Models.Identity;
using Project1.Server.Api.Services.Identity;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Project1.Server.Api.xml"), includeControllerXmlComments: true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Project1.Shared.xml"));
